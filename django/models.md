...
class Pessoa(Models.model):
    ...
    # campo date pode ser null no banco
    birth_date = models.DateField('Data de nascimento', null=True)
    # campo datetime pode ser null no banco
    first_kiss = DateTimeField('Data e hora do primeiro beijo', null=True)
    # campo time pode ser null no banco
    when_wake_up = TimeField('Horário em que acorda', null=True)
    ...
    # campo texto longo permite texo em branco
    ...
    site = models.URLField('Endereço na web')
